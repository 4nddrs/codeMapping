...
| Causal Forcing | Stage 2b consistency distillation and Stage 1 AR diffusion teacher forcing, both 2 optimizer steps of Wan2.1-T2V-1.3B on one traced rank over an 8-row synthetic latent fixture | Stage 2b exit 0 · 1147.7s · losses 0.0014191 then 0.0057983; Stage 1 exit 0 · 531.4s · losses 2.9235 then 2.1149 | [Stage 2b](projects/causal_forcing/index.html), [Stage 1](projects/causal_forcing/ar_train.html) |
| Wan2.2-TI2V-5B | Official inference (generate.py ti2v-5B image-to-video) and DiffSynth-Studio LoRA SFT traces of one architecture, captured on CPU with a tiny random-init stand-in of the 5B checkpoint | Both exit 0; 4 UniPC steps / 2 optimizer steps; values are the tiny model's | [Inference](projects/wan22_ti2v_5b/generate.html), [LoRA training](projects/wan22_ti2v_5b/train_lora.html) |
