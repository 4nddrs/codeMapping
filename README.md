...
| Causal Forcing | `bash docs/code_mapping/capture/run_capture.sh` — Causal Forcing++ Stage 2b consistency distillation of Wan2.1-T2V-1.3B, 2 optimizer steps, one traced rank, 8-row synthetic latent fixture | exit 0 · 1147.7s · 2/2 steps · losses 0.0014191 then 0.0057983 | [Stage 2b](projects/causal_forcing/index.html) |
